package com.ticketseller.backend.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleServiceExceptions(BaseRuntimeException exception) {
        ...
        return createErrorResponse(exception.getHttpStatus(), exception.getErrorCode(), exception.getMessage());
    }
    ...
    public ResponseEntity<ApiResponse<Object>> handleInternalServerErrors(RuntimeException exception) {
        ...
        return createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, ErrorCodes.INTERNAL_SERVER_ERROR, "Internal Server Error.");
    }
    ...
    public ResponseEntity<ApiResponse<Object>> handleMultipartException(MultipartException exception) {
        ...
        return createErrorResponse(HttpStatus.BAD_REQUEST, ErrorCodes.BAD_REQUEST, exception.getMessage());
    }
    ...
    public ResponseEntity<ApiResponse<Object>> handleSizeLimitException(MaxUploadSizeExceededException exception) {
        ...
        return createErrorResponse(HttpStatus.BAD_REQUEST, ErrorCodes.BAD_REQUEST, "File size cannot exceed 5MB");
    }

    @Override
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        return ResponseEntity.status(status).body(
                (Object) createErrorApiResponse(ErrorCodes.BAD_REQUEST, ex.getMessage())
        );
    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        return ResponseEntity.status(status).body(
                (Object) createErrorApiResponse(ErrorCodes.BAD_REQUEST, "Request is not readable, body may be malformed or does not exist.")
        );
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        return ResponseEntity.status(status).body(
                (Object) createErrorApiResponseWithList(ErrorCodes.VALIDATION_FAILED, "Validation errors", finalErrors)
        );
    }

    private ResponseEntity<ApiResponse<Object>> createErrorResponse(HttpStatus httpStatus, int errorCode, String errorMessage) {
        return ResponseEntity
                .status(httpStatus)
                .body(createErrorApiResponse(errorCode, errorMessage));
    }
