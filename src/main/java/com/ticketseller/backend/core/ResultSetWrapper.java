package com.ticketseller.backend.core;
...
import com.ticketseller.backend.exceptions.runtimeExceptions.DatabaseRuntimeException;
...
public final class ResultSetWrapper {
    ...
    public boolean isNull(String columnName) {
        try {
            ...
            throw new DatabaseRuntimeException("Column with given name is not found in SQL query: " + columnName, 0, HttpStatus.NOT_FOUND);
    ...
    private String clobToString(Clob clob) {
        ...
        try {
            ...
            throw new DatabaseRuntimeException("SQL Error while converting clob to string", 0, HttpStatus.NOT_FOUND);
        }
    }
    ...
    public boolean next() {
        try {
            ...
            throw new DatabaseRuntimeException("SQL Error  " + e.getLocalizedMessage(), 0, HttpStatus.NOT_FOUND);
    ...
    public String getColumnName(Integer columnIndex) {
        ...
        try {
            ...
            throw new DatabaseRuntimeException("Column with given index can't found " + columnIndex, 0, HttpStatus.NOT_FOUND);
